...
@AnalyzeClasses(
    packages = "com.tickatch.reservationseatservice",
    importOptions = ImportOption.DoNotIncludeTests.class)
class LayeredArchitectureTest {

  private static final String[] DOMAIN_PACKAGES = {
    "com.tickatch.reservationseatservice.example.domain..",
  };
  ...
  public void layeredArchitecture(JavaClasses classes) {
    Architectures.layeredArchitecture()
        ...
        .layer("Presentation")
        .definedBy("com.tickatch.reservationseatservice..presentation..")
        .layer("Application")
        .definedBy("com.tickatch.reservationseatservice..application..")
        .layer("Domain")
        .definedBy("com.tickatch.reservationseatservice..domain..")
        .layer("Infrastructure")
        .definedBy("com.tickatch.reservationseatservice..infrastructure..")
        ...
        .ignoreDependency(
            ...
            JavaClass.Predicates.resideInAPackage("com.tickatch.reservationseatservice.global.."))
        // 빈 레이어 허용
  ...
  public void globalShouldNotDependOnDomains(JavaClasses classes) {
    ...
    // global 패키지가 없으면 스킵
    if (!hasClassesInPackage(classes, "com.tickatch.reservationseatservice.global..")) {
      return;
    }

    noClasses()
        .that()
        .resideInAPackage("com.tickatch.reservationseatservice.global..")
        .should()
        .dependOnClassesThat()
